...
Below, "internal" represents the successful transactions up to time === 7. We need to update our data and "external1" and "external2" represent 2 possible scenarios encountered when updating the card transactions on our side. Notice that in each scenario there are transactions from time <= 7 that we've already excluded, because the amounts adding up to 434 at time === 7 are 80, 67, 252, 35. So, in scenario 1, we excluded 124 and 125 and in scenario 2 we excluded 212 and 256. The only relevant new transactions, therefore, are from time > 7.
